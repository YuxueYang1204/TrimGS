...
if __name__ == "__main__":
    ...
    parser.add_argument('--DTU', type=str,  default='Official_DTU_Dataset', help='path to the GT DTU point clouds')
    ...
    cmd = f"python {script_dir}/eval.py --data {result_mesh_file} --scan {scan} --mode mesh --dataset_dir {Official_DTU_Dataset} --vis_out_dir {out_dir}"
    os.system(cmd)